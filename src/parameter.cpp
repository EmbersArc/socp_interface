...
Parameter::Parameter(ParameterOperation *operation) : source(operation), sourceType(ParameterSourceType::Operation) {}
...
{
    ParameterOperation *op = new ParameterOperation(lhs, rhs, std::plus<double>());
    return Parameter(op);
}

Parameter operator-(const Parameter &lhs, const Parameter &rhs)
{
    ParameterOperation *op = new ParameterOperation(lhs, rhs, std::minus<double>());
    return Parameter(op);
}

Parameter operator-(const Parameter &par)
{
    ParameterOperation *op = new ParameterOperation(Parameter(-1.0), par, std::multiplies<double>());
    return Parameter(op);
}

Parameter operator*(const Parameter &lhs, const Parameter &rhs)
{
    ParameterOperation *op = new ParameterOperation(lhs, rhs, std::multiplies<double>());
    return Parameter(op);
}

Parameter operator/(const Parameter &lhs, const Parameter &rhs)
{
    ParameterOperation *op = new ParameterOperation(lhs, rhs, std::divides<double>());
    return Parameter(op);
}
